...
<template>
    <div class="pt-4">
        ...
        CounterG:{{ countG }}
        <div class="mt-2">
            <NButton @click="count2++; countG++">+</NButton>
            <NButton @click="count2--; countG--">-</NButton>
    ...
    <NButton @click="counter.increment()" data-testid="increment">+1</NButton>
    <NButton @click="counter.increment(10)">+10</NButton>
    <NButton @click="counter.increment(100)">+100</NButton>
    <NButton @click="counter.n++">Direct Increment</NButton>
    <NButton @click="
        counter.$patch((state) => {
            state.n = 0
    ...
    <NButton @click="counter.fail">Test Errors</NButton>
    <NButton @click="counter.decrementToZero()">Decrement to zero</NButton>
